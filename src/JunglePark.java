...
// Files: Animal.java, Button.java, ParkGUI.java, Tiger.java, Deer.java, AddAnimalButton.java,
...
/**
 * This class contains all information of the Jungle Park. It includes a list of all animals and
 * buttons, sets up the GUI, and draws the GUI. It extends PApplet
 * 
 * @author Mouna Kacem
 *
 */
public class JunglePark extends PApplet {
  ...
  public void setup() {
    ...
    AddAnimalButton tigerButton = new AddAnimalButton("Tiger", 43, 16, this);
    listGUI.add(tigerButton);
    AddAnimalButton deerButton = new AddAnimalButton("Deer", 129, 16, this);
